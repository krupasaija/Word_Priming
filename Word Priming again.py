...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP\\OneDrive\\Desktop\\Word Priming again.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('PsychoPy/Tutorial5 studylist.xlsx'),
